...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _fetchDoctorProfile() async {
    try {
      final response = await http.get(
        Uri.parse(
            '$baseUrl1/semenanalysis/get_doctor_profile.php?doctorId=${widget.doctorId}'),
      );
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success']) {
          setState(() {
            String baseUrl = '$baseUrl1/semenanalysis/';
            doctorName =
  ...
  Future<void> _fetchPatients() async {
    try {
      final response = await http.post(
        Uri.parse('$baseUrl1/semenanalysis/get_patients.php'),
  ...
  Future<void> _deletePatient(String patientId) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('$baseUrl1/semenanalysis/delete_patient.php'),
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => HomePage(doctorId: widget.doctorId),
                  ),
                );
              },
            ),
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 8.0), // Space between search bar and hint
            Row(
              mainAxisSize: MainAxisSize.min, // Wrap content to prevent stretching
              ...
              children: [
                ...
                const Text(
                  ...
                  textAlign: TextAlign.center, // Center the text inside its own bounds
                ),
              ],
            ),
                            ...
                            trailing: PopupMenuButton<String>(
                              onSelected: (value) {
                                if (value == 'Edit') {
                                  ...
                                  _confirmDelete(patient['patientId'].toString());
                                }
                              },
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => PatientDetailsPage(
                                    ...
                                    mobile: patient['mobile'],
                                    imagePath: patient['image_path'],
                                    spermCount: patient['sperm_count'].toString(),
                                    refreshCallback: _refreshPatientList,
                                  ),
                                ),
                              );
                            },
      ...
      floatingActionButton: Padding(
        padding:
        const EdgeInsets.only(bottom: 30.0, right: 10.0), // Adjust padding
